 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(t){t[t["UNKNOWN"]=0]="UNKNOWN",t[t["VISIBLE"]=1]="VISIBLE",t[t["HIDDEN"]=2]="HIDDEN"})(P||(P={}));var D=["firebase_","google_","ga_"],B=new RegExp("^[a-zA-Z]\\w*$"),K=40,q=100;function V(){var t=k.getInstance().navigator;return"serviceWorker"in t?t.serviceWorker.controller?2:3:1}function z(){var t=k.getInstance().document,e=t.visibilityState;switch(e){case"visible":return P.VISIBLE;case"hidden":return P.HIDDEN;default:return P.UNKNOWN}}function x(){var t=k.getInstance().navigator,e=t.connection,n=e&&e.effectiveType;switch(n){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}function $(t){if(0===t.length||t.length>K)return!1;var e=D.some((function(e){return t.startsWith(e)}));return!e&&!!t.match(B)}function W(t){return 0!==t.length&&t.length<=q}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var J=new l.Logger(M);J.logLevel=l.LogLevel.INFO;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var H="0.0.1",G={loggingEnabled:!0},Y="FIREBASE_INSTALLATIONS_AUTH";function Q(t){var e=X();return e?(nt(e),Promise.resolve()):et(t).then(nt).then((function(t){return Z(t)}),(function(){}))}function X(){var t=k.getInstance().localStorage;if(t){var e=t.getItem(E);if(e&&rt(e)){var n=t.getItem(I);if(n)try{var r=JSON.parse(n);return r}catch(o){return}}}}function Z(t){var e=k.getInstance().localStorage;t&&e&&(e.setItem(I,JSON.stringify(t)),e.setItem(E,String(Date.now()+60*O.getInstance().configTimeToLive*60*1e3)))}var tt="Could not fetch config, will use default configs";function et(t){return j().then((function(e){var n=O.getInstance().getProjectId(),r="https://firebaseremoteconfig.googleapis.com/v1/projects/"+n+"/namespaces/fireperf:fetch?key="+O.getInstance().getApiKey(),i=new Request(r,{method:"POST",headers:{Authorization:Y+" "+e},body:JSON.stringify({app_instance_id:t,app_instance_id_token:e,app_id:O.getInstance().getAppId(),app_version:m,sdk_version:H})});return fetch(i).then((function(t){if(t.ok)return t.json();throw C.create("RC response not ok")}))})).catch((function(){J.info(tt)}))}function nt(t){if(!t)return t;var e=O.getInstance(),n=t.entries||{};return void 0!==n.fpr_enabled?e.loggingEnabled="true"===String(n.fpr_enabled):e.loggingEnabled=G.loggingEnabled,n.fpr_log_source&&(e.logSource=Number(n.fpr_log_source)),n.fpr_log_endpoint_url&&(e.logEndPointUrl=n.fpr_log_endpoint_url),n.fpr_log_transport_key&&(e.transportKey=n.fpr_log_transport_key),void 0!==n.fpr_vc_network_request_sampling_rate&&(e.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate)),void 0!==n.fpr_vc_trace_sampling_rate&&(e.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate)),e.logTraceAfterSampling=it(e.tracesSamplingRate),e.logNetworkAfterSampling=it(e.networkRequestsSamplingRate),t}function rt(t){return Number(t)>Date.now()}function it(t){return Math.random()<=t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var pt,ht=1e4,gt=5500,mt=3,dt=mt,vt=[],_t=!1;function yt(){_t||(bt(gt),_t=!0)}function bt(t){setTimeout((function(){if(0!==dt)return vt.length?void wt():bt(ht)}),t)}function wt(){var t=u.__spreadArrays(vt);vt=[];var e=t.map((function(t){return{source_extension_json_proto3:t.message,event_time_ms:String(t.eventTime)}})),n={request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:O.getInstance().logSource,log_event:e};Tt(n,t).catch((function(){vt=u.__spreadArrays(t,vt),dt--,J.info("Tries left: "+dt+"."),bt(ht)}))}function Tt(t,e){return It(t).then((function(t){return t.ok||J.info("Call to Firebase backend failed."),t.json()})).then((function(t){var n=Number(t.nextRequestWaitMillis),r=ht;isNaN(n)||(r=Math.max(n,r));var i=t.logResponseDetails;Array.isArray(i)&&i.length>0&&"RETRY_REQUEST_LATER"===i[0].responseAction&&(vt=u.__spreadArrays(e,vt),J.info("Retry transport request later.")),dt=mt,bt(r)}))}function It(t){var e=O.getInstance().getFlTransportFullUrl();return fetch(e,{method:"POST",body:JSON.stringify(t)})}function Et(t){if(!t.eventTime||!t.message)throw C.create("invalid cc log");vt=u.__spreadArrays(vt,[t])}function St(t){return function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];var r=t.apply(void 0,e);Et({message:r,eventTime:Date.now()})}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ot=100,Rt="_",Ut=[b,w,T];function jt(t,e){return!(0===t.length||t.length>Ot)&&(e&&e.startsWith(y)&&Ut.indexOf(t)>-1||!t.startsWith(Rt))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Dt=function(){function t(t,e,n){void 0===e&&(e=!1),this.name=t,this.isAuto=e,this.state=1,this.customAttributes={},this.counters={},this.api=k.getInstance(),this.randomId=Math.floor(1e6*Math.random()),this.isAuto||(this.traceStartMark=d+"-"+this.randomId+"-"+this.name,this.traceStopMark=v+"-"+this.randomId+"-"+this.name,this.traceMeasure=n||_+"-"+this.randomId+"-"+this.name,n&&this.calculateTraceMetrics())}return t.prototype.start=function(){if(1!==this.state)throw C.create("trace started",{traceName:this.name});this.api.mark(this.traceStartMark),this.state=2},t.prototype.stop=function(){if(2!==this.state)throw C.create("trace stopped",{traceName:this.name});this.state=3,this.api.mark(this.traceStopMark),this.api.measure(this.traceMeasure,this.traceStartMark,this.traceStopMark),this.calculateTraceMetrics(),At(this)},t.prototype.record=function(t,e,n){if(this.durationUs=Math.floor(1e3*e),this.startTimeUs=Math.floor(1e3*t),n&&n.attributes&&(this.customAttributes=u.__assign({},n.attributes)),n&&n.metrics)for(var r=0,i=Object.keys(n.metrics);r<i.length;r++){var o=i[r];isNaN(Number(n.metrics[o]))||(this.counters[o]=Number(Math.floor(n.metrics[o])))}At(this)},t.prototype.incrementMetric=function(t,e){void 0===e&&(e=1),void 0===this.counters[t]&&this.putMetric(t,0),this.counters[t]+=e},t.prototype.putMetric=function(t,e){if(!jt(t,this.name))throw C.create("invalid custom metric name",{customMetricName:t});this.counters[t]=e},t.prototype.getMetric=function(t){return this.counters[t]||0},t.prototype.putAttribute=function(t,e){var n=$(t),r=W(e);if(n&&r)this.customAttributes[t]=e;else{if(!n)throw C.create("invalid attribute name",{attributeName:t});if(!r)throw C.create("invalid attribute value",{attributeValue:e})}},t.prototype.getAttribute=function(t){return this.customAttributes[t]},t.prototype.removeAttribute=function(t){void 0!==this.customAttributes[t]&&delete this.customAttributes[t]},t.prototype.getAttributes=function(){return u.__assign({},this.customAttributes)},t.prototype.setStartTime=function(t){this.startTimeUs=t},t.prototype.setDuration=function(t){this.durationUs=t},t.prototype.calculateTraceMetrics=function(){var t=this.api.getEntriesByName(this.traceMeasure),e=t&&t[0];e&&(this.durationUs=Math.floor(1e3*e.duration),this.startTimeUs=Math.floor(1e3*(e.startTime+this.api.getTimeOrigin())))},t.createOobTrace=function(e,n,r){var i=k.getInstance().getUrl();if(i){var o=new t(y+i,!0),a=Math.floor(1e3*k.getInstance().getTimeOrigin());o.setStartTime(a),e&&e[0]&&(o.setDuration(Math.floor(1e3*e[0].duration)),o.putMetric("domInteractive",Math.floor(1e3*e[0].domInteractive)),o.putMetric("domContentLoadedEventEnd",Math.floor(1e3*e[0].domContentLoadedEventEnd)),o.putMetric("loadEventEnd",Math.floor(1e3*e[0].loadEventEnd)));var s="first-paint",c="first-contentful-paint";if(n){var u=n.find((function(t){return t.name===s}));u&&u.startTime&&o.putMetric(b,Math.floor(1e3*u.startTime));var f=n.find((function(t){return t.name===c}));f&&f.startTime&&o.putMetric(w,Math.floor(1e3*f.startTime)),r&&o.putMetric(T,Math.floor(1e3*r))}At(o)}},t.createUserTimingTrace=function(e){var n=new t(e,!1,e);At(n)},t}();
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Kt=5e3;function qt(){U()&&(setTimeout((function(){return zt()}),0),setTimeout((function(){return Vt()}),0),setTimeout((function(){return xt()}),0))}function Vt(){for(var t=k.getInstance(),e=t.getEntriesByType("resource"),n=0,r=e;n<r.length;n++){var i=r[n];Bt(i)}t.setupObserver("resource",Bt)}function zt(){var t=k.getInstance(),e=t.getEntriesByType("navigation"),n=t.getEntriesByType("paint");if(t.onFirstInputDelay){var r=setTimeout((function(){Dt.createOobTrace(e,n),r=void 0}),Kt);t.onFirstInputDelay((function(t){r&&(clearTimeout(r),Dt.createOobTrace(e,n,t))}))}else Dt.createOobTrace(e,n)}function xt(){for(var t=k.getInstance(),e=t.getEntriesByType("measure"),n=0,r=e;n<r.length;n++){var i=r[n];$t(i)}t.setupObserver("measure",$t)}function $t(t){var e=t.name;e.substring(0,_.length)!==_&&Dt.createUserTimingTrace(e)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Wt=function(){function t(t){this.app=t,k.getInstance().requiredApisAvailable()?(yt(),st().then(qt,qt)):J.info("Firebase Performance cannot start if browser does not support fetch and Promise or cookie is disabled.")}return t.prototype.trace=function(t){return new Dt(t)},Object.defineProperty(t.prototype,"instrumentationEnabled",{get:function(){return O.getInstance().instrumentationEnabled},set:function(t){O.getInstance().instrumentationEnabled=t},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"dataCollectionEnabled",{get:function(){return O.getInstance().dataCollectionEnabled},set:function(t){O.getInstance().dataCollectionEnabled=t},enumerable:!0,configurable:!0}),t}(),Jt="[DEFAULT]";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(t){var e=function(t,e){if(t.name!==Jt)throw C.create("FB not default");if("undefined"===typeof window)throw C.create("no window");return F(window),O.getInstance().firebaseAppInstance=t,O.getInstance().installationsService=e,new Wt(t)};t.INTERNAL.registerComponent(new p.Component("performance",(function(t){var n=t.getProvider("app").getImmediate(),r=t.getProvider("installations").getImmediate();return e(n,r)}),"PUBLIC")),t.registerVersion(h,g)}Ht(i),e.registerPerformance=Ht}}]);